...
class DataColumn extends Column {
    ...
    _renderDataCellContent(model, key, index) {
        if (this.content === null) {
            ...
            return Jii.app.formatter.format(this.getDataCellValue(model, key, index), this.format);
        }

        return super._renderDataCellContent(model, key, index);
    }
