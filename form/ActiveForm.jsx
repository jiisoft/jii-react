...
/**
 * @class Jii.react.form.ActiveForm
 * @extends Jii.react.ReactView
 */
var ActiveForm = Jii.defineClass('Jii.react.form.ActiveForm', /** @lends Jii.react.form.ActiveForm.prototype */{

    __extends: ReactView,

    __static: /** @lends Jii.react.form.ActiveForm */{
